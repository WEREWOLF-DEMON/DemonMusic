...
from Demon.utils import first_page, second_page
from Demon.utils.database import get_lang
from Demon.utils.decorators.language import LanguageStart, languageCB
from Demon.utils.inline.help import help_back_markup, private_help_panel
    ...
    if cb == "hb9":
        if CallbackQuery.from_user.id not in SUDOERS:
            return await CallbackQuery.answer(
                "😎 Pehle @WerewolfDemon Ko Papa Bol Jake 😆😆", show_alert=True
            )
        else:
...
@Client.on_callback_query(filters.regex("WerewolfXDemon") & ~BANNED_USERS)
@languageCB
