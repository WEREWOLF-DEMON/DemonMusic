...
from Demon.utils.inline import botplaylist_markup
        ...
        if not await is_active_chat(chat_id):
            ...
            try:
                ...
                try:
                    ...
                    try:
                        await app.apDEMONve_chat_join_request(chat_id, userbot.id)
                    except Exception as e:
                        return await message.reply_text(
                            _["call_3"].format(app.mention, type(e).__name__)
                        )
        ...
        if not await is_active_chat(chat_id):
            ...
            try:
                ...
                try:
                    ...
                    try:
                        await client.apDEMONve_chat_join_request(chat_id, userbot.id)
                    except Exception as e:
                        await message.reply_text(
                            _["call_3"].format(i.mention, type(e).__name__)
                        )
