...
async def get_thumb(videoid):
    ...
    arial = ImageFont.truetype("Demon/assets/font2.ttf", 30)
    font = ImageFont.truetype("Demon/assets/font.ttf", 30)
    title_font = ImageFont.truetype("Demon/assets/font3.ttf", 45)
    ...
    play_icons = Image.open("Demon/assets/play_icons.png")
